...
format: 
  revealjs:
    theme: [default, estilo/custom.scss]
    code-fold: true
    code-tools: true
    code-link: true
    slide-number: true
    ...
    include-in-header:
      - file: estilo/zoom-image.html
      - file: estilo/zoom-image-loader.html
...
# The Decision to Hold Back: Experimental Evidence on Teachers’ Repetition Biases {.diapositiva-titulo style="background: none;" data-menu-title="Titulo"}
...
- Se testean hipótesis sobre el comportamiento de los profesores dependiendo de sus gustos sobre las políticas y de si esos gustos son complacidos. 
...
Sin resultados significativos: pertenecer al grupo Policy no te hace más o menos duro con respecto al control
:::
...
Sin resultados significativos: pertenecer al grupo Revelation no te hace más o menos duro con respecto al Policy
:::
...
Sin resultados significativos: pertenecer al grupo Awareness no te hace más o menos duro con respecto al Revelation
:::
